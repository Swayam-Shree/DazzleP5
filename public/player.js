...
Player.prototype.moveForward = function(){
	if (this.sprinting){
		player.pos.add(createVector(player.looking.x, 0, player.looking.z).setMag(player.sprintSpeed));
	}
	else {
...
Player.prototype.moveLeft = function(){
	if (this.sprinting){
		player.pos.add(player.looking.cross(up).setMag(player.sprintSpeed));
	}
	else {
